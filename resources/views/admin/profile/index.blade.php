        ...
        <div class="col-xl-3">
            <div class="card sticky-top">
                <div class="list-group list-group-flush" id="useradd-sidenav">
                    ...
                    <a href="#useradd-2" class="border-0 list-group-item list-group-item-action">{{ __('Basic Info') }}
                        <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                    </a>
                    @if (Auth::user()->type == 'Influencer')
                        <a href="#useradd-7"
                            class="border-0 list-group-item list-group-item-action">{{ __('Social Media Links') }}
                            <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                        </a>
                        <a href="#useradd-4"
                            class="border-0 list-group-item list-group-item-action">{{ __('Banner Image') }}
                            <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                        </a>
                    @endif
                    ...
                    @if (Auth::user()->type == 'Influencer')
                        ...
                        <a href="#useradd-96"
                            class="border-0 list-group-item list-group-item-action">{{ __('Subscription Text') }}
                            <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                        </a>
                    @endif
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="avatar me-3">
                            <img src="{{ $user->avatar ?? $user->dp }}" class="img-user rounded-circle"
                                    ...
                                    <div class="pt-0 card-body">
                                        <div class="setting_card">
                                            <div class="logo-content">
                                                <a href="{{ !empty($user->banner_image) ? $user->banner_image : '#' }}"
                                                    target="_blank">

                                                    <img id="banner-preview" src="{{ $user->banner_image }}"
                                                        alt="Banner Image"
            ...
            @if (Auth::user()->type == 'Influencer')
                <div id="useradd-6" class="card">
                    <div class="card-header">
                        ...
                        <small class="text-muted">{{ __('Connect your Stripe account for payments') }}</small>
                    </div>
                    {{ Form::open(['route' => 'profile.verify.stripe', 'method' => 'Post', 'class' => 'form-horizontal', 'data-validate']) }}
                    <div class="card-body">
                        <div class="row form-group">
                            <div class="col-sm-8">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('stripe_account_id', $user->stripe_account_id ?? '', [
                                        ...
                                        'placeholder' => __('Enter your Stripe Account ID'),
                                    ]) !!}
                            ...
                            <div class="col-sm-4">
                                <div class="form-group mt-4">
                                    @if (isset($user->is_stripe_connected) && $user->is_stripe_connected)
                                        ...
                                        <a href="{{ route('stripe.disconnect', $user->id) }}"
                                            class="btn btn-danger">Disconnect Stripe</a>
                                    @else
                ...
                <div id="useradd-9" class="card">
                    ...
                    <div class="card-body">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    {{ Form::label('stripe_tuneup_percentage_fee', __('Stripe Tuneup Percentage Fee'), ['class' => 'form-label']) }}
                                    <select name="stripe_tuneup_percentage_fee" id="stripe_tuneup_percentage_fee"
                                        class="form-select">
                                        <option
                                            {{ $user->stripe_tuneup_percentage_fee == 'instructor' ? 'selected' : '' }}
                                            value="instructor">Instructor</option>
                                        <option {{ $user->stripe_tuneup_percentage_fee == 'student' ? 'selected' : '' }}
                                            value="student">Student</option>
                                    </select>
                ...
                <div id="useradd-96" class="card">
                    ...
                    <div class="card-body">
                        <div class="row form-group">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    {{ Form::label('subscription_heading', __('Subscription Heading'), ['class' => 'form-label']) }}
                                    {!! Form::text('subscription_heading', $user->subscription_heading ?? '', [
                                        'class' => 'form-control',
