        ...
        <div class="col-lg-6 col-12">
            <div class="card">
                <div class="card-body flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-muted text-sm mb-0"> {{ __('Total') }} </p>
                        <h6 class="text-info mb-0"> {{ __('Plan') }} </h6>
                    </div>

                    <h3 class="mb-0 text-info ml-auto text-3xl"> {{ $plan }} </h3>
                </div>
            </div>
        </div>
        @endcan
        ...
        <div class="col-lg-6 col-12">
            <div class="card">
                <div class="card-body flex  items-center gap-3">
                    ...
                    <div>
                        <p class="text-muted text-sm mb-0"> {{ __('Total') }} </p>
                        <h6 class="mb-0 text-warning"> {{ __('Language') }} </h6>
                    </div>
                    <h3 class="mb-0 text-warning ml-auto text-3xl"> {{ $languages }} </h3>
                </div>
            </div>
        </div>
        @endcan
        ...
        <div class="col-lg-6 col-12">
            <div class="card">
                <div class="card-body flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-muted text-sm mb-0"> {{ __('Total') }} </p>
                        <h6 class="mb-0 text-danger"> {{ __('Earning') }} </h6>
                    </div>
                    <h3 class="mb-0 text-danger ml-auto text-3xl"> {{ Utility::amount_format($earning) }} </h3>
                </div>
            </div>
        </div>
        @endif
