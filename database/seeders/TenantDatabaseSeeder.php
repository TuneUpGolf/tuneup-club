...
class TenantDatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $allpermissions  = [
            ...
            'instructors'           => ['manage', 'create', 'edit', 'delete', 'impersonate'],
        ...
        foreach ($instructorpermissions as $instructorModule => $instructorPermissions) {
            Module::firstOrCreate(['name' => $adminmodule]);
            foreach ($instructorPermissions as $instructorPermission) {
                $temp2 = Permission::firstOrCreate(['name' => $instructorPermission . '-' . $instructorModule]);
                $instructorRole->givePermissionTo($temp2);
            }
        }
        ...
        $settings = [
            ...
            ['key' => 'apps_name', 'value' => 'TUNEUP'],
            ['key' => 'apps_bold_name', 'value' => 'Analyzing Golf'],
            ['key' => 'app_detail', 'value' => 'Master Your Swing, One Lesson at a Time.'],
            ...
            ['key' => 'feature_detail', 'value' => 'A Full Tenancy Laravel Admin Saas features collectively create a robust and flexible SaaS platform that serves multiple businesses efficiently while maintaining security, scalability, and compliance with legal requirements.'],
            ...
            ['key' => 'menu_setting_section2_enable', 'value' => 'off'],
            ...
            ['key' => 'menu_setting_section3_enable', 'value' => 'off'],
            ...
            ['key' => 'business_growth_setting_enable', 'value' => 'off'],
            ...
            ['key' => 'faq_setting_enable', 'value' => 'off'],
            ['key' => 'faq_name', 'value' => 'Frequently asked questions'],

            ['key' => 'start_view_setting_enable', 'value' => 'off'],
            ...
            ['key' => 'start_view_link_name', 'value' => 'Register'],
            ['key' => 'start_view_link', 'value' => route('register')],
            ...
            ['key' => 'login_name', 'value' => 'Master Your Swing, One Lesson at a Time.'],
            ['key' => 'login_detail', 'value' => 'Discover the perfect golf instructor tailored to your needs on our dedicated platform. With an array of experts at your fingertips, elevate your golf game seamlessly. Start today and embrace the journey towards your best swing.'],

            ['key' => 'testimonial_setting_enable', 'value' => 'off'],
        ...
        MailTemplate::firstOrCreate([
            ...
            'subject' => 'Feedback for your purchase is added by the instructor',
            'html_template' => '<p>Hello, {{ name }}, feedback for your purchase {{id}} has has been added by the instructor.</p>',
            'text_template' => 'Hello, {{ name }}.'
        ]);
        ...
        MailTemplate::firstOrCreate([
            ...
            'html_template' => '<p>Hello, {{ name }}, Payment was successful against your purchase : {{id}}, please proceed to add videos to recieve feedback by the instructor via app or portal.<br>Regards, Tuneup Management.</p>',
            'text_template' => 'Hello, {{ name }}.'
        ]);
